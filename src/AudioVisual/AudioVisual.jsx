    ...
    <div>
      ...
      >
        ...
        <div style={{ display: "flex", position: "absolute", top: "50%" }}>
          <h1 className={isMobile ? "tituloAudioMobile" : "tituloAudio"}>
            AUDIOVISUAL
          </h1>
        </div>
        <hr
      ...
      <div>
        ...
        >
          <img
            style={
              isMobile
                ? { display: "flex", width: "50", height: 200, margin: 10 }
                : { display: "flex", width: "20%", height: 400, margin: 10 }
            }
          ...
          <img
            style={
              isMobile
                ? { display: "flex", width: "50", height: 200, margin: 10 }
                : { display: "flex", width: "40%", height: 400, margin: 10 }
            }
