    ...
    <div>
      ...
      >
        ...
        <div
          style={
            isMobile
              ? { display: "flex", position: "absolute", top: "60%" }
      ...
      >
        <img
          style={isMobile ? { height: 400, width: 300 } : undefined}
          ref={scrollRef}
          src={`${Urls.TresD}13.png`}
        ></img>
      </div>
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div className="fotos3D">
          <img
            style={isMobile ? { width: 250, height: 200 } : { width: 500 }}
        ...
        <div className="fotos3D">
          <img
            style={
              isMobile
                ? { width: 250, marginBottom: 100, height: 200 }
                : { width: 500, marginBottom: 200, marginTop: -70 }
            }
